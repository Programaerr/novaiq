...
export const UI_TRANSLATIONS = {
  ar: {
    ...
    // Contract Builder
    builderTitle: 'مواصفات مشروعك وتفاصيل التنفيذ',
    builderSubtext: 'اكتب بيانات شركتك ومواصفات مشروعك، ويُبنى عقدك تلقائياً ويُحفظ في حسابك.',
    stepCompanyInfo: '1. بيانات شركتك',
    stepTechSpecs: '2. مواصفات المشروع ومظهره',
    stepSignature: '3. بنود العقد والتوقيع',

    companyNameLabel: 'الاسم / اسم النشاط:',
    companyNamePlaceholder: 'مثال: شركة النجوم للتطوير، أو اسمك الكامل',
    crNumberLabel: 'رقم السجل التجاري (اختياري):',
    crNumberPlaceholder: 'مثال: 104928374',
    repNameLabel: 'الاسم الكامل للتوقيع:',
    repNamePlaceholder: 'اسمك الكامل',
    ...
    customFeaturesPlaceholder: 'اكتب أي ميزات إضافية تريدها في موقعك...',
    colorSchemeLabel: 'ألوان موقعك:',
    languageSupportLabel: 'لغات موقعك:',
    langAr: 'عربي',
    langEn: 'إنجليزي',
    ...
    totalCostSummary: 'التكلفة التقديرية الإجمالية:',
    clearSignature: 'مسح التوقيع',
    agreeTermsCheckbox: 'أوافق على بنود العقد أعلاه، وأقرّ بصحة المواصفات ومراحل التسليم المذكورة.',
    generateContractBtn: 'إتمام العقد وإرساله',
  ...
  en: {
    ...
    stepSignature: '3. Contract terms & signature',

    companyNameLabel: 'Name / Business Name:',
    companyNamePlaceholder: 'e.g. Stella Development, or your full name',
    crNumberLabel: 'Commercial Registration Number (optional):',
    crNumberPlaceholder: 'e.g. 104928374',
    repNameLabel: 'Full Name (Signatory):',
    ...
    colorSchemeLabel: 'Your site colours:',
