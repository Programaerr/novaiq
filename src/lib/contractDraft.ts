...
export interface ContractDraft {
  ...
  /**
   * أيّ مراحل العقد الثلاث كان مفتوحاً (1..3).
   *
   * كانت كلّ الحقول تعود بعد التحديث والمرحلة وحدها لا تعود — تبدأ من الأولى دائماً. ومن كان
   * في "المراجعة والتوقيع" يجد نفسه في "بيانات الشركة" وحقولها مملوءة، فيقرؤها أنّ عقده ضاع
   * لا أنّه انتقل خطوةً للوراء. والمرحلة جزء من مكان المستخدم في النموذج تماماً كما أنّ
   * المكتوب فيه جزء من عمله.
   *
   * وغيابها يعني الأولى — وهو ما كان يحدث دائماً قبل وجودها، فلا تتبدّل مسودّة محفوظة سلفاً.
   */
  step?: number;
}
