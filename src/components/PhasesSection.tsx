...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    ar: {
      name: 'التسليم',
      body: 'يُسلَّم الموقع لصاحب العمل لتجربته قبل التسليم النهائي، وله تعديل بسيط  ضمن النطاق المتفق عليه، وما خرج عنه يُسعَّر على حدة. وإن لم تصلنا ملاحظات خلال 7 أيام تُعتبر المرحلة معتمدة، ويُسلَّم الكود وصلاحيات الإدارة بعد اكتمال السداد.',
    },
    en: {
      name: 'Delivery',
                  ...
                  <div className="min-w-0 pt-0.5">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <span
                        ...
                        style={{ background: V.ORANGE, color: V.SURFACE_LIGHT }}
                        aria-hidden="true"
                      >
                    ...
                    <p
                      ...
                      style={{ color: V.OBSIDIAN, opacity: 0.78 }}
                    >
