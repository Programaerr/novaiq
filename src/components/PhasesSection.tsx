...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    ar: {
      name: 'التسليم',
      body: 'يُسلَّم الموقع لصاحب العمل لتجربته قبل التسليم النهائي، وله  تعديل مجانيتان ضمن النطاق المتفق عليه، وما خرج عنه يُسعَّر على حدة. وإن لم تصلنا ملاحظات خلال 7 أيام تُعتبر المرحلة معتمدة، ويُسلَّم الكود وصلاحيات الإدارة بعد اكتمال السداد.',
    },
    en: {
      name: 'Delivery',
