                ...
                return (
                  <li key={index} className="flex items-start gap-4 sm:gap-5">
                    ...
                    <div className="min-w-0 flex-1">
                      {/* الأيقونة فوق العنوان على الهاتف، وبجانبه من sm فصاعداً.

                          العلّة أنّ الفجوة المكتوبة ليست الفجوة المرئيّة. `gap-3` تفصل
                          الأيقونة عن *صندوق* العنوان، والصندوق يملأ العرض المتاح كلّه حين
                          يلتفّ النصّ — بينما حبر السطر يقف حيث انتهت آخر كلمة وسعت. فيبقى
                          بين الأيقونة وأوّل حرف تراه عينُك فراغُ التعرّج كلّه.

                          مقيس على 393px قبل التغيير، الفجوة من الأيقونة إلى الحبر:
                          54.6px و41.8px و12px و53.5px — أي تشتّتٌ 42.6px بين أربع أيقونات
                          يُفترض أنّها عمود واحد. و12px وحدها هي العنوان الوحيد الذي لم
                          يلتفّ. وعلى الحاسبة الأربعة 16px بالتساوي وتشتّتها صفر، لأنّ
                          لا شيء يلتفّ هناك — فالخلل في الالتفاف لا في التصميم.

                          ولا يُحلّ بتضييق الفجوة: العنوان الأطول يحتاج 269px في سطر واحد
                          والمتاح له 218px، فالالتفاف حتميّ على الهاتف. وما دام حتميّاً،
                          فأيّ أيقونة على الجهة المقابلة للنصّ ستلاحق حافّةً متعرّجة. فالصفّ
                          يصير عموداً هناك: الأيقونة على حافّة البداية فوق العنوان، ولا
                          علاقة أفقيّة بينهما تتعرّج أصلاً.

                          و`flex-col-reverse` لا `flex-col`: الأيقونة آخر الأبناء في
                          الـDOM — والترتيب هناك مقصود، فالعنوان هو ما يُقرأ أوّلاً. */}
                      <div className="flex flex-col-reverse items-start gap-2.5 sm:flex-row sm:items-center sm:gap-4">
