...
export const NqButton = React.forwardRef<HTMLButtonElement, NqButtonProps>(function NqButton(
  {
    ...
    type = 'button',
    tileSurface,
    /* حقل المكعّبات تحت المؤشّر — مُشغَّل افتراضياً.
     *
     * وهو حقل WebGL حقيقي (ButtonTiles)، لا محاكاة CSS: المكعّبات مائلة بزاوية الموقع نفسها،
     * لها أوجه مضاءة ومظلّلة، وترتفع حول المؤشّر وتتموّج من نقطة الضغط. جُرّبت نسخة CSS منه
     * فكانت شبكة مربّعات مسطّحة — نفس الفكرة، لا نفس الشيء.
     *
     * وثمنه مضبوط في nqSurface لا مُلغى: لا يُركَّب أبداً داخل ضغطة (هذا ما كان يجمّد كل
     * نقرة)، ولا يتجاوز عدده حقلين حيّين في الموقع كلّه. */
    tiles = true,
    disabled,
    onPointerEnter,
    onPointerMove,
