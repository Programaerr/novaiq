...
export function StatTile({ icon: Icon, label, value, accent }: { icon: React.ComponentType<{ className?: string }>; label: string; value: string; accent?: string }) {
  ...
  return (
    <div className="p-4 rounded-2xl bg-paper border border-ink/10 flex items-center justify-between gap-3">
      ...
      <div className="w-10 h-10 rounded-xl bg-white/70 border border-ink/10 flex items-center justify-center text-ink shrink-0">
