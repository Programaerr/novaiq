...
/* لوحة "العقود المكبوتة" حُذفت مع سجلّ المحذوفات المحلّي.
   وُجدت لتُحضر عقوداً أُخفيت في متصفّح الأدمن ولم تُحذف من الخادم. ولم يعد للتخزين المحلّي
   وجود، فلا يمكن أن تنشأ تلك الحالة — ولوحة تعالج عطلاً مستحيلاً تُقرأ كأن العطل ما زال
   ممكناً. */
