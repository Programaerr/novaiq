...
export const PageBackBar: React.FC<PageBackBarProps> = ({ language, title, onBack, onHome }) => {
  ...
  return (
    ...
    >
      ...
      <div className="glass-bar page-in pointer-events-auto flex items-center gap-2 bg-black/55 backdrop-blur-md border border-white/15 rounded-2xl px-3 py-2 sm:px-4 sm:py-2.5">
        <button
          type="button"
          onClick={onBack}
