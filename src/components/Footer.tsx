          ...
          <div className="lg:col-span-4">
            ...
            {socials.length > 0 && (
              ...
              <div className="mt-12 flex flex-wrap items-center gap-x-4 gap-y-3">
                {/* العنوان بجانب الأيقونات لا فوقها.

                    فوقها هو الموضع الطبيعيّ، وهو المشغول: الفقّاعة تبلغ 40px فوق حافّة
                    الصفّ (انظر الفراغ أعلاه)، فأيّ سطرٍ يوضع هناك تنزل عليه الفقّاعة عند
                    أوّل مرور — وهو نفس العطل الذي وُضع `mt-12` ليمنعه عن الفقرة. ولإبعاده
                    عنها يلزم 48px بينه وبين الأيقونات، فيصير أقرب إلى الفقرة التي فوقه من
                    الأيقونات التي يسمّيها. وبجانبها لا يقع تحت الفقّاعة أصلاً: هي ترتفع
                    فوق الصفّ، وهو داخله.

                    و`nq-label` ليست زينة: التتبّع على العربيّة يفصل الحروف المتّصلة، والصنف
                    هو ما يُلغيه في RTL ويُبقيه في الإنجليزيّة. انظر `[dir='rtl'] .nq-label`
                    في index.css — وهو اختياريّ، فالنسيان هنا يُخرج «تواصلوا معنا» حروفاً
                    مفكّكة. */}
                <span className="nq-label text-xs sm:text-sm uw:text-base font-bold tracking-[0.18em] uppercase text-[rgb(var(--ft-fg)/var(--ft-a50))]">
                  {isAr ? 'تواصلوا معنا' : 'Get in touch'}
                </span>

                {/* الأيقونات في غلافها الخاصّ، وهذا لازم لا ترتيب: القصّ على الهاتف يُنتقى
                    بـ`.nq-social-slot:first-child/:last-child` (انظر index.css). لو وقف
                    العنوان أخاً لها لصار هو الابن الأوّل، فتفقد أوّل فقّاعة قصَّها وتخرج
                    عن حافّة الشاشة. */}
          ...
          <div className="lg:col-span-4">
              ...
              >
                ...
                <NqButton
                  ...
                  badge={<Arrow className="w-3.5 h-3.5" strokeWidth={2.6} />}
                >
