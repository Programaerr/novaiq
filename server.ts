...
// كلاهما يحتاج مفتاح service_role، ومفتاح كهذا لا يجوز أن يعيش في خادم Node عادي على
// Netlify (لا يُنشر أصلاً)، بل في بيئة دالّة محقونة تلقائياً لا يُكتب فيها سرّ إضافي.
//
