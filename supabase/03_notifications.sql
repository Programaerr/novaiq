...
--
--  وأسرار الدالّة نفسها بوتان منفصلان لا بوت واحد (جُرِّب نظام Forum Topic لكل عقد وتعثّر
--  بإعداد تيليجرام نفسه، فاستُبدل ببوتين بسيطين): TELEGRAM_CONTRACT_BOT_TOKEN للعقود
--  وTELEGRAM_SUBSCRIBER_BOT_TOKEN للمشتركين — وكلاهما يرسل إلى نفس القائمة
--  TELEGRAM_ADMIN_CHAT_ID (أنت وشريكك). كود الدالّة نفسه لا يوجد في المستودع — هو منشور في
--  Supabase مباشرة (Edge Functions ← notify) وأي تعديل لاحق يكون من محرّرها هناك. تُضبط من لوحة
