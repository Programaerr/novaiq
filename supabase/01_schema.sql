...
--
--  ٣) `user_id` يشير إلى auth.users، و`firebase_uid` يبقى بجانبه.
--     تسجيل الدخول بـGoogle في Supabase يُصدر uuid جديداً لا علاقة له بـuid فايربيس. العمود
--     القديم يبقى محفوظاً حتى يسجّل كل زبون دخوله مرّة (فيُربط بالبريد)، وبعدها يُحذف. حذفه
--     قبل ذلك = زبون يفتح حسابه فلا يجد عقوده.
-- ═══════════════════════════════════════════════════════════════════════════════════════
