...
/**
 * حارس النشر: لا يُرفع إلى الاستضافة إلا ما يحتاجه الموقع فعلاً.
 *
 * ## لماذا حارس لا مجرّد ثقة
 * الاستضافة تنشر مجلّد `dist` كما هو. وVite يبنيه من مصدرين: ملفاتنا المترجَمة، و**كل ما في
 ...
 *
 * يُشغَّل بعد البناء مباشرة (جزء من `npm run build`)، ففشله يعني نشراً لم يقع — لا
 * نشراً وقع ثم اكتُشف.
 */
